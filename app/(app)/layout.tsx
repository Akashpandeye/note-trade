  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-50 dark:bg-gray-950">
      ...
      <div className="pointer-events-none absolute inset-0">
        {/* Light-mode glow */}
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_80%_60%_at_50%_-20%,rgba(56,189,248,0.18),transparent)] dark:hidden" />
        <div className="absolute inset-0 bg-[linear-gradient(to_bottom,rgba(255,255,255,0.6)_0%,rgba(226,232,240,0.9)_70%)] dark:hidden" />
